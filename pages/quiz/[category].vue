<template>
  <main class="quiz-container p-4 md:p-0 w-full">
    ...
    <!-- Loading state -->
    <div v-if="loading" class="flex flex-col justify-center items-center h-64" role="status" aria-live="polite">
      ...
      <p class="text-preset-4 text-blue-900 dark:text-white">Loading quiz questions...</p>
    </div>
